            ...
            <div class="row">
                <div class="col-12">
                    <div class="text-center">
                        <h3>Input the OSA information</h3>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-8 m-auto">
                                <form class="multisteps-form__form mb-8" method="POST" enctype="multipart/form-data"
                                    action="osaData/ctrl.add.osa.php">
                                    <!--single form panel-->
                                    <div class="card multisteps-form__panel p-3 border-radius-xl bg-white js-active"
                                        data-animation="FadeIn">
                                        <h5 class="font-weight-bolder mb-0">Add OSA</h5>
                                        ...
                                        <div class="multisteps-form__content mt-1">
                                            ...
                                            <div class="button-row d-flex mt-7">
                                                ...
                                                <button class="btn bg-gradient-dark ms-auto mb-0" type="submit"
                                                    title="Send" name="submit">Add OSA</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
