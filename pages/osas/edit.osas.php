    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
        ...
        <div class="container-fluid py-4">
            <div class="col-lg-11 mt-lg-0 mt-4 mx-auto">
                    ...
                    <div class="row justify-content-center align-items-center">
                        <div class="col-sm-auto col-4">
                            <div class="avatar avatar-xl position-relative">
                                <?php
                                $getUserData = mysqli_query($db, "SELECT *, CONCAT(tbl_osas.osas_firstname, ' ', tbl_osas.osas_middlename, ' ', tbl_osas.osas_lastname) AS fullname FROM tbl_osas WHERE osas_id = '$osas_id'");
                        ...
                        <form method="POST" enctype="multipart/form-data" action="osaData/ctrl.edit.osa.php"
                ...
                <!-- Card Basic Info -->
                <form method="POST" enctype="multipart/form-data" action="osaData/ctrl.edit.osa.php" class="card mt-4"
                    id="basic-info">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="input-group">
                                    <input id="lastName" name="lname" class="form-control" type="text"
                                        ...
                                        value="<?php echo $row['osas_lastname'];
                                                                                                                                        ?>">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                ...
                                <div class="input-group">
                                    <input id="firstName" name="fname" class="form-control" type="text"
                                        ...
                                        value="<?php echo $row['osas_firstname'];
                                                                                                                                        ?>">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                ...
                                <div class="input-group">
                                    <input id="middlename" name="mname" class="form-control" type="text"
                                        placeholder="Middlename" value="<?php echo $row['osas_middlename']; ?>">
                                </div>
                            </div>
                ...
                <form class="card mt-4 mb-5" id="password" method="POST" action="osaData/ctrl.edit.osa.php">
                    <div class="card-header">
